...
const SERVER_MESSAGES = {
  ru: {
    ...
    DATABASE_TEMPORARY_ERROR: "Не удалось обновить баланс кредитов. Попробуйте позже.",
  ...
  en: {
    ...
    DATABASE_TEMPORARY_ERROR: "The credit balance could not be updated. Please try again later.",
  ...
  lv: {
    ...
    DATABASE_TEMPORARY_ERROR: "Neizdevās atjaunināt kredītu atlikumu. Mēģiniet vēlāk.",
